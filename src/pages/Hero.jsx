      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="lg:pl-8">
            <div className="shadow-card-shadow border-2 rounded-2xl justify-center p-2">
              <div>
              ...
              <div className=''>
                <form onSubmit={handleStartQuiz} className="space-y-6">
                  ...
                  <button 
                    type="submit" 
                    className="w-full h-12 text-base font-semibold text-white bg-black rounded-xl hover:bg-gray-800"
                    disabled={isLoading}
                  >
                    {isLoading ? (
